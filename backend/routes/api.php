...
use \App\Http\Controllers\CarrierControllerler;
...
Route::POST('/carrier/add', [CarrierControllerler::class, 'store'])->name('carrier.store');
Route::get('/carriers', [CarrierControllerler::class, 'index'])->name('carrier.index');
Route::get('/carriers/{id}', [CarrierControllerler::class, 'show'])->name('product.show');
